...
# ==============================================================================
    ...
    if df_base_completa.empty:
        ...
        if menu == "dashboard":
            ...
            with col_exp2:
                st.info("💡 **Dica para Apresentações:** Você pode tirar um print dos gráficos limpos usando o atalho `Win + Shift + S` para colar direto nos seus slides!")

        # ==============================================================================
        # VISÃO: EPIS VENCIDOS / A VENCER
        # ==============================================================================
        elif menu == "vencidos":
